# NOTE: This file should not be edited. This file is a copy of the original spinapi.py file from SpinCore Technologies, Inc.
# This can be found at:
# https://www.spincore.com/support/SpinAPI_Python_Wrapper/Python_Wrapper_Main.shtml
# As of 12/28/2024, an older version of the spin api is included in the pulseblaster 
# python package installed with qdl-utils as indicated by the pyproject.toml file. 
# That version should no longer be used, and this should be used instead.
